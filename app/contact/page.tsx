...
import { Mail, MessageSquare, Send, User, Instagram, Linkedin, MapPin, Globe, Sparkles, X, MessageCircle, AtSign, ChevronRight, CheckCircle2, ArrowRight, Terminal, Zap } from "lucide-react";
...
const ContactPage = () => {
    ...
    const itemVariants = {
        ...
        visible: { y: 0, opacity: 1, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] as any } }
    };

    const floatingLabelVariants = {
        inactive: { y: 0, scale: 1, opacity: 0.3 },
        active: { y: -24, scale: 0.85, opacity: 1, transition: { type: "spring", stiffness: 300, damping: 20 } }
    } as any;
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-black dark:text-white transition-colors duration-500 selection:bg-[#0DA5F0]/30 dark:selection:bg-[#F90101]/30 overflow-x-hidden">
                    ...
                    >
                        <div className="space-y-8">
                            <motion.div variants={itemVariants} className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">Direct Access</span>
                            </motion.div>

                            <motion.h1 variants={itemVariants} className="text-7xl md:text-92xl font-black tracking-tighter leading-[0.85]">
                                Get In<br />
                                <span className="text-[#0DA5F0] dark:text-[#F90101]">Touch</span>
                            </motion.h1>
                            ...
                            <motion.div variants={itemVariants} className="space-y-6">
                                <p className="text-xl dark:text-white/40 text-black/40 font-medium max-w-sm leading-tight border-l-2 border-[#0DA5F0]/20 dark:border-[#F90101]/20 pl-6">
                                    Bridge the gap between idea and execution. Our team is ready to scale your next project.
                                </p>
                        ...
                        <div className="mt-12 space-y-8">
                            <motion.div variants={itemVariants} className="grid grid-cols-1 gap-10">
                                <div className="group">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] opacity-30 mb-4">Official Channel</p>
                                    <a href="mailto:thehackshastra@gmail.com" className="text-2xl font-black hover:text-[#0DA5F0] dark:hover:text-[#F90101] transition-colors duration-300 flex items-center gap-3">
                                ...
                                <div className="group">
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] opacity-30 mb-4">Base of Operations</p>
                                    <p className="text-2xl font-black flex items-center gap-3 hover:text-[#0DA5F0] dark:hover:text-[#F90101] transition-colors duration-300">
                                        New Delhi, India <Globe className="w-5 h-5 opacity-40 group-hover:rotate-12 transition-transform" />
                                    </p>
                                </div>
                            </motion.div>
                            ...
                            <motion.div variants={itemVariants} className="space-y-6 pt-4">
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-20 ml-2">Satellite Uplinks</p>
                                <div className="flex items-center gap-3 p-3 rounded-[2.5rem] bg-black/[0.03] dark:bg-white/[0.03] border border-black/5 dark:border-white/5 backdrop-blur-3xl w-fit shadow-inner">
                                    {[
                                        { icon: Linkedin, href: "https://linkedin.com/company/hackshastraa", color: "#0077B5", label: "LinkedIn" },
                                        { icon: Instagram, href: "https://instagram.com/hackshastra", color: "#E4405F", label: "Insta" },
                                        { icon: X, href: "https://x.com/hackshastra", color: "#000000", label: "X.com" },
                                        { icon: AtSign, href: "https://www.threads.net/@hackshastra", color: "#60A5FA", label: "Threads" }
                                    ].map((social, i) => (
                                        <motion.a
                                            key={i}
                                            href={social.href}
                                        ...
                                        >
                                            ...
                                            <social.icon className="w-6 h-6 relative z-10" strokeWidth={2.5} />
                            ...
                            {status === "success" ? (
                                ...
                                >
                                    <div className="bg-white dark:bg-[#0c0c0c] rounded-[3.3rem] p-12 md:p-20 text-center space-y-8 relative overflow-hidden backdrop-blur-4xl shadow-2xl">
                                        <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.05] pointer-events-none" style={{ backgroundImage: `radial-gradient(circle, currentColor 1px, transparent 1px)`, backgroundSize: '15px 15px' }} />
                                        ...
                                        >
                                            <CheckCircle2 size={48} className="text-[#0DA5F0] dark:text-[#F90101]" />
                                        </motion.div>

                                        <div className="space-y-4 relative z-10">
                                            <h2 className="text-5xl font-black tracking-tighter uppercase">Message<br />Sent</h2>
                                            <p className="text-xl opacity-40 font-medium max-w-xs mx-auto">Your message has been received. Our team will get back to you shortly.</p>
                                        </div>
                                        ...
                                        <div className="p-8 md:p-12 space-y-10 relative">
                                            ...
                                            <div className="flex justify-between items-end border-b border-black/5 dark:border-white/5 pb-8">
                                                <div className="space-y-1">
                                                    <span className="text-[9px] font-black uppercase tracking-[0.5em] text-[#0DA5F0] dark:text-[#F90101]">Community Portal</span>
                                                    <p className="text-[10px] font-bold opacity-30">Status: Awaiting your message</p>
                                                </div>
                                                    ...
                                                    >
                                                        ...
                                                        <span className="relative z-10 flex items-center gap-5 group-hover/btn:text-white dark:group-hover/btn:text-white transition-colors duration-500">
                                                            {status === "loading" ? (
                                                                ...
                                                                <>
                                                                    Send Message <Send size={18} strokeWidth={2.5} className="group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1 transition-transform" />
                                                                </>
                                                            )}
                                                        </span>
                                                    </motion.button>
                                                    ...
                                                    <AnimatePresence>
                                                        {status === "error" && (
                                                            ...
                                                            >
                                                                ...
                                                                {errorMsg || "Unable to send. Please check your connection."}
                                                            </motion.div>
                                                        )}
                                                    </AnimatePresence>
                                                </div>
            ...
            <div className="fixed left-10 bottom-10 hidden xl:block pointer-events-none">
                <span className="text-[12px] font-black opacity-10 tracking-[1em] rotate-180 [writing-mode:vertical-lr]">HACKSHASTRA // COMMUNITY</span>
            </div>
        </div>
    );
};
